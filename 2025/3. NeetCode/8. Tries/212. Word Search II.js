...
// Time Complexity: O(m*n*4^l) --> m = rows, n = columns, l = length of the word, 4 because of 4 directions
// Space Complexity: O(l) --> l = sum of all word lengths